...
RUN pip install --no-cache-dir -r requirements.txt -c https://raw.githubusercontent.com/openstack/requirements/refs/heads/stable/2026.1/upper-constraints.txt
